...
def put(x0, k, r, t, sigma, q):
    ...
    cum_norm_1 = norm.cdf(-d_2(x0, k, r, sigma, t, q))
    cum_norm_2 = norm.cdf(-d_1(x0, k, r, sigma, t, q))

    return np.exp(-r * t) * (k * cum_norm_1 - x0 * np.exp((r - q) * t) * cum_norm_2)
